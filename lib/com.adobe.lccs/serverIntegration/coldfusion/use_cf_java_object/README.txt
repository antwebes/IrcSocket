...
4) Create AccountManager object and store in sessoin object (e.g. <cfset Session.accountmanager = createObject("java", "com.adobe.rtc.account.AccountManager").init(accounturl)>)
