...
* to invoke http hooks on your Ruby on Rail server and allowing your application to recieve LCCS real time events 
...
2) update rubyamf_config.rb with functional mapppings
