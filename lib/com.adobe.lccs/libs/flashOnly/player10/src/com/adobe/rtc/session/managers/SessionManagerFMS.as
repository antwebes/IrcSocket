...
//			var origin:String = "localhost";
		...
		override session_internal function recordMessages(p_startStop:Boolean=true, p_collectionName:String=null, p_nodeName:String=null,p_baseUrl:String=null):void
		{
			if ( _fmsConnector.nc ) {
				_fmsConnector.nc.call("recordMessages", null, p_startStop, p_collectionName, p_nodeName,p_baseUrl);
			}
		}
		
		override session_internal function recordStreams(p_startStop:Boolean=true, p_groupName:String=null, p_type:String=null, p_streamID:String=null,p_baseUrl:String=null):void
		{
			if ( _fmsConnector.nc ) {
				_fmsConnector.nc.call("recordStreams", null, p_startStop, p_groupName, p_type, p_streamID,p_baseUrl);
			}
		}
