   ...
   public class  ConnectSession extends EventDispatcher implements IConnectSession
	{
		 ...
		 */
		public static const BUILD_NUMBER:String = "1.3.5";
		 ...
		 * @private 
		 */
		protected var _recordSessionSet:Boolean = false;
		/**
		 * @private 
		 */
		protected var _recordSession:Boolean = false;
...
//			_messageManager.addEventListener(CollectionNodeEvent.SYNCHRONIZATION_CHANGE, checkManagerSync);
		...
		public function logout():void
		{
			...
			if ( archiveManager.isRecording ) {
				archiveManager.recordSession = false ;
			}
