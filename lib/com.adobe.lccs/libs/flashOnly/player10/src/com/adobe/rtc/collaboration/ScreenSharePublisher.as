...
import flash.display.Sprite //FlashOnlyReplacement;
	 ...
	 * 
	 * <b>What is NOT in this feature</b>
	 * Ability to control screen during a screen share session is an advanced feature. As of now, ScreenSharePublisher does not allow user to control screen.
	 * 
...
//[Bindable("isScreenSharePublishingChanged")]
		...
		public function publish():void
		{
				...
				!_isLaunched && !_isPublishing)
			{
				...
				_addInLauncher = new AddInLauncher(_addInRequiredVersion, _addInName, _addInLocation);
