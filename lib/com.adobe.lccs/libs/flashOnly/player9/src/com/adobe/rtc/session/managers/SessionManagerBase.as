   ...
   public class  SessionManagerBase extends EventDispatcher
	{
		...
		*/
		 ...
		 * 
		 */
		session_internal function recordMessages(p_startStop:Boolean=true, p_collectionName:String=null, p_nodeName:String=null, p_baseUrl:String=null):void
		{
			// Reference implementation : echoing the request back to the collection
			if (isLocalManager) {
//				setTimeout(receiveUserRole, asynchTimer, p_userID, p_role, p_collectionName, p_nodeName);
		 ...
		 * 
		 */
		session_internal function recordStreams(p_startStop:Boolean=true, p_groupName:String=null, p_type:String=null, p_streamID:String=null, p_baseUrl:String=null):void
		{
			// Reference implementation : echoing the request back to the collection
			if (isLocalManager) {
//				setTimeout(receiveUserRole, asynchTimer, p_userID, p_role, p_collectionName, p_nodeName);
